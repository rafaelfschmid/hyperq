    ...
    cudaStream_t& stream)
{
    ...
    {
        gpu_radix_sort_local<<<grid_sz, block_sz, shmem_sz, stream>>>(d_out,
                                                                d_prefix_sums, 
                                                                d_block_sums, 
                                                                shift_width, 
                                                                d_in, 
        ...
        sum_scan_blelloch(d_scan_block_sums, d_block_sums, d_block_sums_len, stream);

        // scatter/shuffle block-wise sorted array to final positions
        gpu_glbl_shuffle<<<grid_sz, block_sz, 0, stream>>>(d_in,
                                                    d_out, 
                                                    d_scan_block_sums, 
                                                    d_prefix_sums, 
                                                    shift_width, 
